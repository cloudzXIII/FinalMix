...
function SMODS.calculate_main_scoring(context, scoring_hand)
    if context.cardarea == G.play and next(SMODS.find_card('j_kh_lethimcook')) and SMODS.calculate_round_score() > G.GAME.blind.chips and G.GAME.current_round.hands_played == 0 then
		-- call normal scoring
